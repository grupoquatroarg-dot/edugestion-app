          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-hidden flex flex-col">
              <div className="p-6 grid grid-cols-3 gap-6 border-b border-zinc-100">
                <div>
                  <label className="block text-xs font-bold text-zinc-400 uppercase tracking-widest mb-2">Proveedor</label>
                  <select
                    required
              ...
              <div className="p-6 bg-zinc-50 border-t border-zinc-100 flex justify-between items-center">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="px-6 py-2 rounded-xl border border-zinc-200 text-zinc-600 font-bold hover:bg-white transition-all"
                  >
                    Cancelar
                  </button>
                  {hasPermission('products', 'edit') && (
                    <button
                      type="submit"
                      className="px-8 py-2 rounded-xl bg-zinc-900 text-white font-bold hover:bg-zinc-800 transition-all shadow-lg shadow-zinc-200 flex items-center gap-2"
                    >
                      <Save size={18} />
                      Guardar Factura
                    </button>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-6 bg-zinc-50 border-t border-zinc-100 flex justify-end">
              <button
                ...
                className="px-6 py-2 rounded-xl bg-zinc-900 text-white font-bold hover:bg-zinc-800 transition-all"
              >
                Cerrar
              </button>
            </div>
